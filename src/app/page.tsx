...
const PROJECT_META: Record<string, { subtitle: string; thumbnail: string; date: string; href?: string; objectFit?: 'cover' | 'contain' | 'fill' | 'none' | 'scale-down' }> = {
  ...
  'initia-app':               { subtitle: 'Initia App 1.0 — Designing Without Data',                        thumbnail: '/assets/initia/initia_app_01.png', date: '2024', href: '/case-studies/initia-app' },
  'initia-app-v2':            { subtitle: 'Initia App 2.0 — Redesigning for the Users Who Stayed',          thumbnail: '/assets/initia/initia_app2_01.png', date: '2026', href: '/case-studies/initia-app-v2' },
...
const VISIBLE_SLUGS = ['initia-ecosystem', 'anchor', 'fount-robo-advisor', 'virtuswap'];
