...
const PROJECT_META: Record<string, { subtitle: string; thumbnail: string; date: string; href?: string; objectFit?: 'cover' | 'contain' | 'fill' | 'none' | 'scale-down'; aspectRatio?: string }> = {
  ...
  'cross-remittance':         { subtitle: 'Blockchain remittance UX for migrant workers in Korea — trust, KYC, and simplicity for underserved users', thumbnail: '/assets/cross/cross_thum.jpg', date: '2019', href: '/case-studies/cross-remittance' },
};
