...
export const TYPE = {
  ...
  h3_32SemiBold: text('var(--cs-page-title-size)', 300, 'var(--cs-page-title-line-height, 1.3)', '-0.32px', { margin: '0 0 var(--cs-page-title-gap)' }),
  ...
  pTitle_16Bold: text('var(--cs-meta-label-size, 16px)', 500, 'var(--cs-meta-label-line-height, 1.5)', '-0.16px', { margin: '0 0 var(--cs-meta-label-gap, 12px)' }),
  p16: text('var(--cs-body-text-size, 16px)', 400, 'var(--cs-body-line-height, 1.5)', '-0.16px'),
  p16SemiBold: text('var(--cs-emphasis-text-size, 16px)', 600, 1.5, '-0.16px'),
  p56Regular: text('clamp(42px, 2.9167vw, 56px)', 300, 1.2, '-0.01em'),
