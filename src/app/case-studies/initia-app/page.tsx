  ...
  return (
    <main style={{ backgroundColor: CS.color.white, color: CS.color.ink }}>
      ...
      >
        ...
        <FullBleedImage src="/assets/initia_app/initia_app_01.jpg" aspect="16 / 9" />
        ...
        <div style={{ marginTop: CS.space.stack, display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <FullBleedImage src="/assets/initia_app/initia_app_04.mp4" />
        ...
        <SplitSection title={<SectionTitle>Outcome</SectionTitle>} pb={0}>
